...
const SignUpScreen = ({ route }) => {
    ...
    const handleRegistration = async (values) => {
        setLoading(true);
        const { error } = await signUp({ username: values.email, password: values.password });
        if (error) {
            console.log(error);
            setLoading(false);
            setError(error);
    ...
    return (
        ...
        >
            ...
            <Formik
                initialValues={{ fistname: '', lastname: '', email: '', password: '', confirmPassword: '' }}
                ...
                {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
                    <View>
                        <View style={styles.container}>
                            ...
                            />
                            {touched.fistname && errors.fistname && <Text style={styles.errorText}>{errors.fistname}</Text>}

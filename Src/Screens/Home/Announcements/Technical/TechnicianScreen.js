...
import TechnicianHeader from "../../../../Components/PostComponents/Headers/AnnouncementsHeaders/Technical/TechnicianHeader";
...
export default function TechnicianScreen() {
  ...
  const fetchItems = async () => {
    ...
    setLoading(true);
    const additionalFilter= { tag_roles: { contains: "Technician" } };
  ...
  return (
    <FlatList
      ...
      ListHeaderComponent={<TechnicianHeader />}

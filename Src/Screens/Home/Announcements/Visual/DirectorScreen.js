...
import DirectorHeader from "../../../../Components/PostComponents/Headers/AnnouncementsHeaders/Visual/DirectorHeader";
...
export default function DirectorScreen() {
  ...
  const fetchItems = async () => {
    ...
    setLoading(true);
    const additionalFilter = { tag_roles: { contains: "Director" } };
  ...
  return (
    <FlatList
      ...
      ListHeaderComponent={<DirectorHeader />}

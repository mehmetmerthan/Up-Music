...
import BeatmakerHeader from "../../../../Components/PostComponents/Headers/AnnouncementsHeaders/Producers/BeatmakerHeader";
...
export default function BeatmakerScreen() {
  ...
  const fetchItems = async () => {
    ...
    setLoading(true);
    const additionalFilter = { tag_roles: { contains: "Beatmaker" } };
  ...
  return (
    <FlatList
      ...
      ListHeaderComponent={<BeatmakerHeader />}

...
import VideographyHeader from "../../../../Components/PostComponents/Headers/AnnouncementsHeaders/Visual/VideographyHeader";
import { useRoute } from "@react-navigation/native";
export default function VideographyScreen() {
  ...
  const fetchItems = async () => {
    ...
    setLoading(true);
    const additionalFilter= { tag_roles: { contains: "Videographer" } };
  ...
  return (
    <FlatList
      ...
      ListHeaderComponent={<VideographyHeader />}

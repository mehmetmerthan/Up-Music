...
import DjHeader from "../../../../Components/PostComponents/Headers/ProfilesHeaders/Performance/DjHeader";
...
export default function DjScreen() {
  ...
  const fetchItems = async () => {
    ...
    setLoading(true);
    const additionalFilter = { tag_roles: { contains: "dj" } };

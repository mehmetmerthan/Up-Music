...
export default function ManagementFilterScreen() {
  ...
  function submitFilter() {
    ...
    if (filter.or.length > 0) {
      navigation.navigate("AnnouncementsManagementScreen", { filter: filter });
    } else {
      navigation.navigate("AnnouncementsManagementScreen");
    }
    setLoading(false);
  }
  function reset() {

...
import PhotographerHeader from "../../../../Components/PostComponents/Headers/AnnouncementsHeaders/Visual/PhotographerHeader";
...
export default function PhotographerScreen() {
  ...
  const fetchItems = async () => {
    ...
    setLoading(true);
    const additionalFilter = { tag_roles: { contains: "Photographer" } };
  ...
  return (
    <FlatList
      ...
      ListHeaderComponent={<PhotographerHeader />}

...
import InstrumentalistHeader from "../../../../Components/PostComponents/Headers/AnnouncementsHeaders/Performance/InstrumentalistHeader";
...
export default function InstrumentalistScreen() {
  ...
  const fetchItems = async () => {
    ...
    setLoading(true);
    const additionalFilter = { tag_roles: { contains: "instrumentalist" } };

...
export default function PublicistFilterScreen() {
  ...
  function submitFilter() {
    ...
    if (filter.or.length > 0) {
      navigation.navigate("AnnouncementsPublicistScreen", { filter: filter });
    } else {
      navigation.navigate("AnnouncementsPublicistScreen");
    }
    setLoading(false);
  }
  function reset() {

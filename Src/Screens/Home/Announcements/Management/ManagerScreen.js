...
import ManagerHeader from "../../../../Components/PostComponents/Headers/AnnouncementsHeaders/Management/ManagerHeader";
...
export default function ManagerScreen() {
  ...
  const fetchItems = async () => {
    ...
    setLoading(true);
    const additionalFilter = { tag_roles: { contains: "manager" } };
  ...
  return (
    <FlatList
      ...
      ListHeaderComponent={<ManagerHeader />}
